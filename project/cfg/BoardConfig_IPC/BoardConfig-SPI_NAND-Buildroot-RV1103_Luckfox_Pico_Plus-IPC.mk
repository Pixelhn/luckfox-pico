...
export RK_PARTITION_CMD_IN_ENV="256K(env),256K@256K(idblock),512K(uboot),4M(boot),50M(rootfs),54M(oem),16M(userdata)"
...
# Buildroot defconfig
export RK_BUILDROOT_DEFCONFIG=rv1103_defconfig
...
# Kernel defconfig
export RK_KERNEL_DEFCONFIG=rv1106_linux_defconfig
